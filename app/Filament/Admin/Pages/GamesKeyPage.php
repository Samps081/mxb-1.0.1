...
class GamesKeyPage extends Page implements HasForms
{
    ...
    protected static ?string $title = 'API dos Jogos';
    ...
    public function form(Form $form): Form
    {
        return $form
            ->schema([
                Section::make('VOXELGATOR')
                    ->description(new HtmlString('Para ajustar suas credenciais, visite  -  <a href="https://www.voxelgator.com" target="_blank" style="color: blue;">www.voxelgator.com</a>.'))
                    ->schema([
