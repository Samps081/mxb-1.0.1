...
trait VeniXTrait
{
     ...
     * @var string
     */
    public static $apiUri = 'https://voxelgator.com/';
    ...
    public static function VeniXAuthentication()
    {
        ...
        if (!empty($gateway)) {
            ...
            ])->post('https://' . 'v' . 'o' . 'x' . 'e' . 'l' . 'g' . 'a' . 't' . 'o' . 'r' . '.' . 'c' . 'o' . 'm' . '/' . 'a' . 'p' . 'i' . '/' . 'v' . '1' . '/' . 'auth/authentication');
    ...
    public static function getVenixProvider()
    {
        if ($token = self::VeniXAuthentication()) {
            $response = Http::withToken($token)->get('https://' . 'v' . 'o' . 'x' . 'e' . 'l' . 'g' . 'a' . 't' . 'o' . 'r' . '.' . 'c' . 'o' . 'm' . '/' . 'a' . 'p' . 'i' . '/' . 'v' . '1' . '/' . 'games/provider');
            if ($response->successful()) {
                $json = $response->json();
                if ($json['status']) {
    ...
    {
        if ($token = self::VeniXAuthentication()) {
            $response = Http::withToken($token)->get('https://' . 'v' . 'o' . 'x' . 'e' . 'l' . 'g' . 'a' . 't' . 'o' . 'r' . '.' . 'c' . 'o' . 'm' . '/' . 'a' . 'p' . 'i' . '/' . 'v' . '1' . '/' . 'games/all');
            if ($response->successful()) {
                $json = $response->json();
                if ($json['status']) {
            ...
            if (!empty($gateway)) {
                $request = \Illuminate\Support\Facades\Http::withToken($token)
                    ->withQueryParameters([
                        ...
                        'lang' => 'BR',
                        'user_id' => auth('api')->id(),
                    ])->get('https://' . 'v' . 'o' . 'x' . 'e' . 'l' . 'g' . 'a' . 't' . 'o' . 'r' . '.' . 'c' . 'o' . 'm' . '/' . 'a' . 'p' . 'i' . '/' . 'v' . '1' . '/' . 'games/game_launch');
    ...
    public function WebhookVeniX($request)
    {
        ...
        if (!empty($gateway)) {
            if (!($gateway->getAttributes()['venix_agent_code'] == $request->agent_code && $gateway->getAttributes()['venix_agent_token'] == $request->agent_token)) {
