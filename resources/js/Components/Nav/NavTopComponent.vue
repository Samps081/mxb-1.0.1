        ...
        <div class="px-3 lg:px-5 lg:pl-3 nav-menu">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start py-3">
                    ...
                    <a v-if="setting" href="/" class="flex ml-2 md:mr-24 ml-4">
                        <div class="hidden sm:block">
                            <img :src="`/storage/`+setting.software_logo_black" alt="" class="h-11 w-50 mr-3 block dark:hidden" /> <!-- Altere o tamanho aqui -->
                            <img :src="`/storage/`+setting.software_logo_white" alt=""  class="h-11 w-50 mr-3 hidden dark:block" /> <!-- Altere o tamanho aqui -->
                        </div>
                        <div class="block sm:hidden">
                            <img :src="`/storage/`+setting.software_favicon" class="h-10 w-14 mr-3" alt="" />
                            <!-- <img :src="`/storage/`+setting.software_logo_black" alt="" class="h-8 w-26 mr-3 block dark:hidden" />
                            <img :src="`/storage/`+setting.software_logo_white" alt=""  class="h-8 w-26 mr-3 hidden dark:block" />  -->
                        </div>
                    </a>
                </div>
