    ...
    <aside :class="[
        ...
        <div class="h-full pb-4 overflow-y-auto sidebar-color p-4">
            <ul class="">
                ...
                <!--                            type="button"-->
                <!--                            class="promo-register transition duration-700 text-sm ease-in-out font-bold py-2 px-3 w-full">-->
            ...
            <ul class="sidebar-base space-y-2 font-medium">
                <li class="px-3">
                    <RouterLink :to="{ name: 'home' }" active-class="link-active" class="transition duration-700 bg-gray-100 dark:bg-transparent hover:bg-gray-200 dark:hover:bg-transparent flex items-center p-2 text-gray-700 font-normal dark:text-gray-400 dark:hover:text-white group">
                ...
                <li class="px-3">
                    <RouterLink :to="{ name: 'casinos' }" active-class="link-active" class="transition duration-700 bg-gray-100 dark:bg-transparent hover:bg-gray-200 dark:hover:bg-transparent flex items-center p-2 text-gray-700 font-normal dark:text-gray-400 dark:hover:text-white group">
                        <i class="fa-light fa-gamepad-modern"></i>
                        <span class="ml-3">{{ $t('Casino') }}</span>
                    </RouterLink>
                </li>

                <li class="px-3" v-if="isAuthenticated">
                    <RouterLink :to="{ name: 'profileWallet' }" active-class="link-active" class="transition duration-700 bg-gray-100 dark:bg-transparent hover:bg-gray-200 dark:hover:bg-transparent flex items-center p-2 text-gray-700 font-normal dark:text-gray-400 dark:hover:text-white group">
                ...
                <li class="px-3">
                    <div class="bg-gray-100 dark:bg-transparent">
                        <button type="button" class="transition duration-700 bg-gray-100 dark:bg-transparent hover:bg-gray-200 dark:hover:bg-transparent flex items-center w-full p-2 text-gray-700 font-normalgroup dark:text-gray-400 dark:hover:text-white"
                        ...
                        <ul id="dropdown-casino-categories" class="block py-2 space-y-2 ">
                            <li v-for="(category, index) in categories" :key="index">
                                <RouterLink :to="{ name: 'casinosAll', params: { provider: 'all', category: category.slug }}" active-class="category-active"
                                            class="flex items-center w-full p-2 text-gray-700 font-normal transition duration-700 group dark:text-gray-400 dark:hover:text-white">
            ...
            <ul class="sidebar-base font-medium mt-2 mb-[200px] rounded-none">
                <li class="px-3">


                    <a @click="$router.push('/profile/affiliate')" href="#" class="l-5 flex items-center w-full p-2 text-gray-700 font-normal transition duration-700 group dark:text-gray-400 dark:hover:text-white">
                    ...
                    <a @click="$router.push('/support')" href="#" class="l-5 flex items-center w-full p-2 text-gray-700 font-normal transition duration-700 group dark:text-gray-400 dark:hover:text-white">
                    ...
                    <!-- <a @click="$router.push('/support-center')" href="#" class="transition duration-700 bg-gray-100 dark:bg-transparent hover:bg-gray-200 dark:hover:bg-transparent flex items-center p-2 text-gray-700 font-normal dark:text-gray-400 dark:hover:text-white group">
